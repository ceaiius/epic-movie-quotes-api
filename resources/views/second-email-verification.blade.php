...
<body style="background: #181624; color:white;font-family: 'Montserrat', sans-serif; word-wrap: break-word; ">
    <div style="padding:2% 8%">
        ...
        <p style="margin-bottom: 32px">Thanks for joining Movie quotes! We really appreciate it. Please click the button below to verify your secondary email::
        </p>
        <a href="{{env('APP_URL').'home/verify-new-email?token='.$email->token}}"
            style="max-width: 128px;padding:7px 13px;color:white;background:#E31221;text-decoration: none;font-weight: 400;
            border-radius:4px">Verify your email</a>
        ...
        <a href="{{env('APP_URL').'home/verify-new-email?token='.$email->token}}"
            ...
            {{env('APP_URL').'home/verify-new-email?token='.$email->token}}</a>
